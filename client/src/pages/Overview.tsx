    ...
    <div className="p-6 space-y-6">
      ...
      <div className={`grid grid-cols-1 gap-6 ${isManager ? 'md:grid-cols-3' : 'md:grid-cols-2'}`}>
        <Link href="/leads/create">
          <Card className="p-6 hover-elevate active-elevate-2 cursor-pointer bg-primary/10 border-primary/20" data-testid="card-skapa-lead">
            <div className="flex items-start justify-between">
              <div>
                <p className="text-sm font-medium text-primary">Skapa Lead</p>
                <p className="text-base text-foreground mt-2" data-testid="value-skapa-lead">Lägg till nytt lead</p>
              </div>
